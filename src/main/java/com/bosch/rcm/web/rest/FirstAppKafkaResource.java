...
@RestController
@RequestMapping("/api/first-app-kafka")
public class FirstAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FirstAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FirstAppKafkaResource(KafkaProperties kafkaProperties) {
